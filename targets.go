...
func generateTargetObj(crate string, target string, program Program) Target {
	defaultTargetEnv := map[string]string{
		...
		"BUILDTOPIA_EXEC":            program.exec,
		"BUILDTOPIA_UTILS":           fmt.Sprintf("%v utils", program.exec),
...
func targetsEdit(crate Crate, targets []Target, program Program) functionResponse {
	hook := "edit"
	response := targetsRunHooks(crate, targets, []string{}, []string{}, []string{hook}, false, false, false, false, false, program)
...
func targetsBuild(crate Crate, targets []Target, cratePreHooks []string, cratePostHooks []string, program Program) functionResponse {
	hook := "build"
	response := targetsRunHooks(crate, targets, []string{hook}, cratePreHooks, cratePostHooks, false, false, false, false, false, program)

	return response
}

func targetsCheck(crate Crate, targets []Target, cratePreHooks []string, cratePostHooks []string, program Program) functionResponse {
	hook := "check"
	response := targetsRunHooks(crate, targets, []string{hook}, cratePreHooks, cratePostHooks, false, false, false, false, false, program)
...
func targetsInstall(crate Crate, targets []Target, cratePreHooks []string, cratePostHooks []string, program Program) functionResponse {
	hook := "install"
	response := targetsRunHooks(crate, targets, []string{hook}, cratePreHooks, cratePostHooks, false, false, false, false, false, program)
...
func targetsClean(crate Crate, targets []Target, cratePreHooks []string, cratePostHooks []string, program Program) functionResponse {
	hook := "clean"
	response := targetsRunHooks(crate, targets, []string{hook}, cratePreHooks, cratePostHooks, false, false, false, false, false, program)
...
func targetsUpdate(crate Crate, targets []Target, cratePreHooks []string, cratePostHooks []string, program Program) functionResponse {
	hook := "update"
	response := targetsRunHooks(crate, targets, []string{hook}, cratePreHooks, cratePostHooks, false, false, false, false, false, program)
