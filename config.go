...
func initializeDefaultProgram(customUserDataDir string) Program {
	// PROGRAM NAME
	programName := "buildtopia"

	// PROGRAM NAME ASCII
	programNameAscii := " _           _ _     _ _              _\n" +
	...
	programShortDescription := "A versatile tool designed for efficiently storing, managing, and building packages and programs. It offers the convenience of templates, empowering users to easily create new crates and targets. With its comprehensive features, buildtopia streamlines the development process and enhances productivity."
	programLongDescription := fmt.Sprintf("%v is a versatile tool designed for efficiently storing, managing, and building packages and programs. It offers the convenience of templates, empowering users to easily create new crates and targets. With its comprehensive features, buildtopia streamlines the development process and enhances productivity.", programName)
