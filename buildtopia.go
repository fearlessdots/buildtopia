...
func main() {
	...
	var targetsBuildCmd = &cobra.Command{
		Use:   "build",
		Short: "Build targets",
		Run: func(cmd *cobra.Command, args []string) {
			crate, selectedTargets, response := getSelectedTargetsFromCLI(crateName, targetNames, allTargets, interactiveSelection, true, program)
			...
			response = targetsBuild(crate, selectedTargets, cratePreHooks, cratePostHooks, program)
			handleFunctionResponse(response, true)
		},
	}

	targetsBuildCmd.Flags().StringVarP(&crateName, "crate", "c", "", "Crate name")
	targetsBuildCmd.Flags().StringSliceVarP(&targetNames, "target", "t", nil, "Target(s) name(s)")
	targetsBuildCmd.Flags().BoolVarP(&allTargets, "all", "a", false, "Include all targets")
	targetsBuildCmd.Flags().BoolVarP(&interactiveSelection, "interactive", "i", false, "Interactive selection")
	targetsBuildCmd.Flags().StringSliceVarP(&cratePreHooks, "cratepre", "", nil, "Crate pre hook(s)")
	targetsBuildCmd.Flags().StringSliceVarP(&cratePostHooks, "cratepost", "", nil, "Crate post hook(s)")
	targetsBuildCmd.Flags().SetInterspersed(false)

	var targetsCheckCmd = &cobra.Command{
		Use:   "check",
		Short: "Check targets",
		Run: func(cmd *cobra.Command, args []string) {
			crate, selectedTargets, response := getSelectedTargetsFromCLI(crateName, targetNames, allTargets, interactiveSelection, true, program)
			...
			response = targetsCheck(crate, selectedTargets, cratePreHooks, cratePostHooks, program)
			handleFunctionResponse(response, true)
		},
	}

	targetsCheckCmd.Flags().StringVarP(&crateName, "crate", "c", "", "Crate name")
	targetsCheckCmd.Flags().StringSliceVarP(&targetNames, "target", "t", nil, "Target(s) name(s)")
	targetsCheckCmd.Flags().BoolVarP(&allTargets, "all", "a", false, "Include all targets")
	targetsCheckCmd.Flags().BoolVarP(&interactiveSelection, "interactive", "i", false, "Interactive selection")
	targetsCheckCmd.Flags().StringSliceVarP(&cratePreHooks, "cratepre", "", nil, "Crate pre hook(s)")
	targetsCheckCmd.Flags().StringSliceVarP(&cratePostHooks, "cratepost", "", nil, "Crate post hook(s)")
	targetsCheckCmd.Flags().SetInterspersed(false)
	...
	var targetsInstallCmd = &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			response = targetsInstall(crate, selectedTargets, cratePreHooks, cratePostHooks, program)
			handleFunctionResponse(response, true)
		},
	}

	targetsInstallCmd.Flags().StringVarP(&crateName, "crate", "c", "", "Crate name")
	targetsInstallCmd.Flags().StringSliceVarP(&targetNames, "target", "t", nil, "Target(s) name(s)")
	targetsInstallCmd.Flags().BoolVarP(&allTargets, "all", "a", false, "Include all targets")
	targetsInstallCmd.Flags().BoolVarP(&interactiveSelection, "interactive", "i", false, "Interactive selection")
	targetsInstallCmd.Flags().StringSliceVarP(&cratePreHooks, "cratepre", "", nil, "Crate pre hook(s)")
	targetsInstallCmd.Flags().StringSliceVarP(&cratePostHooks, "cratepost", "", nil, "Crate post hook(s)")
	targetsInstallCmd.Flags().SetInterspersed(false)

	var targetsCleanCmd = &cobra.Command{
		Use:   "clean",
		Short: "Clean targets",
		Run: func(cmd *cobra.Command, args []string) {
			crate, selectedTargets, response := getSelectedTargetsFromCLI(crateName, targetNames, allTargets, interactiveSelection, true, program)
			...
			response = targetsClean(crate, selectedTargets, cratePreHooks, cratePostHooks, program)
			handleFunctionResponse(response, true)
		},
	}

	targetsCleanCmd.Flags().StringVarP(&crateName, "crate", "c", "", "Crate name")
	targetsCleanCmd.Flags().StringSliceVarP(&targetNames, "target", "t", nil, "Target(s) name(s)")
	targetsCleanCmd.Flags().BoolVarP(&allTargets, "all", "a", false, "Include all targets")
	targetsCleanCmd.Flags().BoolVarP(&interactiveSelection, "interactive", "i", false, "Interactive selection")
	targetsCleanCmd.Flags().StringSliceVarP(&cratePreHooks, "cratepre", "", nil, "Crate pre hook(s)")
	targetsCleanCmd.Flags().StringSliceVarP(&cratePostHooks, "cratepost", "", nil, "Crate post hook(s)")
	targetsCleanCmd.Flags().SetInterspersed(false)
	...
	var targetsUpdateCmd = &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			response = targetsUpdate(crate, selectedTargets, cratePreHooks, cratePostHooks, program)
			handleFunctionResponse(response, true)
		},
	}

	targetsUpdateCmd.Flags().StringVarP(&crateName, "crate", "c", "", "Crate name")
	...
	targetsUpdateCmd.Flags().StringSliceVarP(&cratePreHooks, "cratepre", "", nil, "Crate pre hook(s)")
	targetsUpdateCmd.Flags().StringSliceVarP(&cratePostHooks, "cratepost", "", nil, "Crate post hook(s)")
	...
	targetsCmd.AddCommand(targetsBuildCmd)
	targetsCmd.AddCommand(targetsInstallCmd)
	targetsCmd.AddCommand(targetsCheckCmd)
	targetsCmd.AddCommand(targetsCleanCmd)
